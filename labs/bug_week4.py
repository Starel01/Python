...
grades_to_test = [95, 90, 85, 80, 72, 65, 100] #add your own grades
...
#   95    | You got an A!        |   A    |pass
#   90    | You got an A!        |     A  |pass
#   85    | You got a B!         |    B   |pass
#   80    | You got a B!         | Keep..   fail
#   72    | Keep working at it.  | Keep..    fail
#   __65__  |Keep working at it. |    Keep working at it.    |     <- add your own
#   __100__  | You got an A!______  |  You got an A!      |     <- add your own
...
users_to_test = ["admin", "guest", "natalie", "hacker","Re"]#- add your own
...
# TEST CASE TABLE  (fill in ACTUAL, then mark PASS or FAIL)
#   INPUT   | EXPECTED                                   | ACTUAL | PASS?
#   admin   | Welcome, admin!                            |   warning fail
#   guest   | WARNING: 'guest' is not an approved user!  |   welcome fail
#   natalie | Welcome, natalie!                          |   warning fail
#   hacker  | WARNING: 'hacker' is not an approved user! |   welcome fail
#   _Re_____  | WARNING: 'Re' is not an approved user!  |  pass      |  <- add your own
...
ages_to_test = [1, 5, 12, 13, 15, 19, 20, 45,90]      # <-- add your own
...
#   5     | child    |   child     | pass
#   12    | child    |    child    |pass
#   13    | teenager |    teen    |pass
#   15    | teenager |    teen    |fail
#   19    | teenager |    teen    |fail
#   20    | adult    |    teen    |fail
#   45    | adult    |    teen    |fail
#   _90___  | ___adult_____ |   adult     |  pass <- add your own
...
requests_to_test = ["Pepperoni", "Mushrooms", "mushrooms", "Pineapple","green peppers"]   # <-- add your own
...
# TEST CASE TABLE  (fill in ACTUAL, then mark PASS or FAIL)
#   INPUT     | EXPECTED                        | ACTUAL | PASS?
#   Pepperoni | Adding pepperoni.               |  adding pep      |pass
#   Mushrooms | Adding mushrooms.               |  adding mush      |pass
#   mushrooms | Adding mushrooms.               |   sorry     |fail
#   Pineapple | Sorry, we don't have Pineapple. |   sorry     |pass
#   _green pepper_______  | ____adding green peppers |    adiing green peppers pass    |  <- add your own
